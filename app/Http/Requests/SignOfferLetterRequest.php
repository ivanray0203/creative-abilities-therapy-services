...
/**
 * A candidate returning a signed offer letter. The signature arrives as a
 * PNG data URI drawn on a canvas, so it is validated by shape rather than as
 * an uploaded file — the same check SignInvoiceRequest makes.
 */
class SignOfferLetterRequest extends FormRequest
{
    /** Authorisation is the signed URL on the route. */
