...
/** Document purposes offered for intakes (reference: modals/UploadDocumentModal.tsx). */
const DOCUMENT_PURPOSES = [
    'FSCD Approval Letter',
    'FSCD Service Contract',
    'First Nations Status Documentation',
    'Band/Community Letter',
    'Insurance Card Copy',
...
export default function UploadDocumentModal({
    ...
    const submit = () => {
        post(`/admin/intake/${intake.id}/documents`, {
            forceFormData: true,
            preserveScroll: true,
            ...
            <DialogContent className="max-h-[90vh] w-full max-w-md overflow-y-auto p-6">
                <DialogHeader>
                    ...
                    <p className="text-sm font-normal text-muted-foreground">
                        Upload a document related to this intake and specify its
                        purpose.
                    </p>
                </DialogHeader>
                ...
                <div className="space-y-3">
                    ...
                    <div className="mt-4 rounded-[5px] border border-blue-600 bg-blue-100 p-5">
                        <p className="flex flex-row gap-3 text-xs text-blue-700">
                            ...
                            the intake&apos;s document history and will be
