...
/** Reference: cats-frontend/src/pages/admin/intake/Notes.tsx */
export default function NotesTab({
    ...
    const addNote = () => {
        ...
        patch(`/admin/intake/${intake.id}/notes`, {
            preserveScroll: true,
    ...
    const deleteNote = (noteId: string) => {
        router.delete(`/admin/intake/${intake.id}/notes/${noteId}`, {
            preserveScroll: true,
        });
    };
            ...
            <Card className="rounded-[10px]">
                <CardContent className="p-5">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Team notes and comments about this intake
                    </p>
