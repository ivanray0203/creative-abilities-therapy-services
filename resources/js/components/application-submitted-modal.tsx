        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="max-h-[90vh] w-full max-w-md overflow-y-auto p-6">
                ...
                <p className="text-center text-muted-foreground">
                    Thank you for your application! We appreciate your interest
                    in joining the Creative Abilities Therapy Services team.
                </p>
                ...
                <div className="mt-4 space-y-4 rounded-sm bg-secondary-orange/10 p-5">
                    ...
                    <ul className="list-disc space-y-1 pl-5">
                        <p className="flex flex-row gap-2">
                            <CircleCheck className="text-primary-orange" /> Our
                            team will review your application within 5-7
                            business days.
                        </p>
                        <p className="flex flex-row gap-2">
                            <CircleCheck className="text-primary-orange" />
                            We'll contact you via email if your qualifications
                            match our needs.
                        </p>
                        <p className="flex flex-row gap-2">
                            <CircleCheck className="text-primary-orange" />{' '}
                            Please check your spam folder if you don't hear from
                            us.
                        </p>
                    </ul>
                </div>
