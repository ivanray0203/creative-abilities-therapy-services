/**
 * Static fallback service data, ported from cats-frontend/src/json/temp.tsx (tempServices).
 * ServiceDetail falls back to an entry here when a requested service id isn't
 * found in the database, exactly like the reference.
 */
...
export const tempServices: FallbackService[] = [
    {
        id: 1,
        ...
        short_description: '',
        description:
            'Our Occupational Therapists (OTs) support your child in building functional skills and greater independence in daily life. Using a personalized approach, sensory strategies, and fun hands-on activities, we partner with families to create an environment where children can learn, grow, and thrive.',
        duration_minutes: 60,
        base_price: 120,
        is_active: true,
        benefits: [
