...
The session for **{{ $session->client?->displayName() ?? 'your child' }}** has been moved.

@if ($previousStart !== null)
**Previously:** ~~{{ $previousStart->format('l, j F Y \a\t g:i A') }}~~
@endif

@component('mail::table')
| | |
|:--|:--|
| **Now** | {{ $session->scheduled_start?->format('l, j F Y \a\t g:i A') ?? 'To be confirmed' }} |
...
If this new time does not work for you, please contact us and we will rearrange it.
